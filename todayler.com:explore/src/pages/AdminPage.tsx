        ...
        <div className="w-full max-w-2xl mx-auto">
          <div className="bg-amber-50 border border-amber-200 p-6 text-amber-900">
            ...
            <p className="text-sm leading-relaxed mb-6">
              {isGreek
                ? 'Το 8loop ξεκλειδώνει άμεσα την πρόσβαση διαχείρισης. Χρησιμοποιήστε τον κωδικό από το footer promo και επιστρέψτε εδώ.'
                : '8loop unlocks admin access directly. Use the promo code from the footer, then come back here.'}
            </p>
            <Link
              to="/explore"
